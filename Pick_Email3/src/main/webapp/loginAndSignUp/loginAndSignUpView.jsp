	...
	<div class="container">
		<div class="row">
			...
			<div class="col offset-s4 s4 z-depth-1 grey lighten-4" style="padding: 30px 30px 0px 30px; border: 1px solid #EEE;"">
				...
				<!-- 	임시비번 받을 이메일 입력하는 inputTag		 -->			
					<div class='row' id="UserId_forgetPass" style="display:none;">
						<div class='input-field col s12'>
							<input class='validate' type='email' name='userEmail' id='EmCheck' value="" />
							<label for='email'>Enter your email</label>
						</div>
					</div>
					<!-- 	임시비번 받을 이메일 입력하는 inputTag		 -->	
					...
					<div class='row'>
						<div id="find_pw_btn" class='col s12 btn btn-large waves-effect indigo' style="display:none;">Send Password</div>
					</div>
			...
			<div class="col offset-s4 s4 center">
				...
				<div id="change_register_form_forgot" class="change_btn" style="cursor: pointer;">Forgot Password?</div>
...
/* 			$(this).removeAttr("disabled");
			...
			$("#UserId_forgetPass").css("display" , "none");
			$("#find_pw_btn").css("display" , "none");

			$("#login_form").css("display", "show");
       ...
       /////////////////////////////////추가된 부분 /////////////////////////////////////
		$("#change_register_form_forgot").on("click", function() {
			$(this).removeAttr("disabled");
			$("#UserId").css("display" , "none");
			$("#UserPass").css("display" , "none");
			$("#change_register_form").css("display", "none");
			
			
			$("#login_btn").css("display" , "none");
			$("#fb_login_btn").css("display" , "none");
			
			$("#UserId_forgetPass").css("display" , "inline");
			$("#find_pw_btn").css("display" , "inline");
			$("#change_login_form").css("display", "inline");
